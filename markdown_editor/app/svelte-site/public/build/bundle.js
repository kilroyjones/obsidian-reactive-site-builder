    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 1, 0, 61);
    			attr_dev(a0, "href", "/storage/binary");
    			add_location(a0, file$2, 2, 63, 141);
    			attr_dev(a1, "href", "/storage/primary");
    			add_location(a1, file$2, 2, 189, 267);
    			attr_dev(a2, "href", "/storage/secondary");
    			add_location(a2, file$2, 2, 312, 390);
    			add_location(p0, file$2, 2, 0, 78);
    			add_location(strong, file$2, 3, 13, 468);
    			attr_dev(a3, "href", "/storage/magnetic");
    			add_location(a3, file$2, 3, 86, 541);
    			attr_dev(a4, "href", "/storage/optical");
    			add_location(a4, file$2, 3, 137, 592);
    			add_location(p1, file$2, 3, 0, 455);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code, file$4, 1, 5, 38);
    			add_location(pre, file$4, 1, 0, 33);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$f, 2, 3, 86);
    			attr_dev(a1, "href", "/peripherals/mouse");
    			add_location(a1, file$f, 2, 73, 156);
    			attr_dev(a2, "href", "/peripherals/binary");
    			add_location(a2, file$f, 2, 125, 208);
    			attr_dev(a3, "href", "/storage/binary");
    			add_location(a3, file$f, 2, 191, 274);
    			add_location(p, file$f, 2, 0, 83);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_sidebar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$j, 55, 4, 2658);
    			add_location(br0, file$j, 55, 60, 2714);
    			attr_dev(a1, "href", "/storage");
    			add_location(a1, file$j, 56, 4, 2725);
    			add_location(br1, file$j, 56, 54, 2775);
    			attr_dev(a2, "href", "/peripherals");
    			add_location(a2, file$j, 57, 4, 2786);
    			add_location(br2, file$j, 57, 62, 2844);
    			attr_dev(span, "slot", "sidebar");
    			add_location(span, file$j, 54, 2, 2632);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$j, 59, 2, 2863);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
