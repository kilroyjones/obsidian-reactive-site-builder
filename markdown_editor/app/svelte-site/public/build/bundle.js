...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$g, 90, 10, 1774);
    			attr_dev(div, "class", "answer svelte-1l0v68a");
    			add_location(div, file$g, 89, 8, 1743);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$g, 87, 6, 1645);
    			attr_dev(div, "class", "question svelte-1l0v68a");
    			add_location(div, file$g, 86, 4, 1616);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$g, 102, 8, 2102);
    			attr_dev(div1, "class", "col-sm-4");
    			add_location(div1, file$g, 101, 6, 2071);
    			attr_dev(div2, "class", "data-column incorrect svelte-1l0v68a");
    			add_location(div2, file$g, 105, 8, 2202);
    			attr_dev(div3, "class", "col-sm-4 ");
    			add_location(div3, file$g, 104, 6, 2170);
    			attr_dev(div4, "class", "data-column score svelte-1l0v68a");
    			add_location(div4, file$g, 108, 8, 2305);
    			attr_dev(div5, "class", "col-sm-4");
    			add_location(div5, file$g, 107, 6, 2274);
    			attr_dev(div6, "class", "row data-row svelte-1l0v68a");
    			add_location(div6, file$g, 100, 4, 2038);
    			attr_dev(div7, "class", "question svelte-1l0v68a");
    			add_location(div7, file$g, 99, 2, 2011);
    			attr_dev(div8, "class", "container");
    			add_location(div8, file$g, 84, 0, 1540);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Quiz extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$j, create_fragment$j, safe_not_equal, { questions: 0 });
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p0 = element("p");
    			create_component(quiz0.$$.fragment);
    			t2 = text(" and ");
    			create_component(quiz1.$$.fragment);
    			t3 = text(" and ");
    			create_component(quiz2.$$.fragment);
    			t4 = text(" vs. ");
    			create_component(quiz3.$$.fragment);
    			t5 = space();
    			br0 = element("br");
    			center = element("center");
    			img = element("img");
    			...
    			add_location(h1, file$i, 1, 0, 51);
    			add_location(br0, file$i, 3, 0, 1044);
    			if (img.src !== (img_src_value = "static/assets/magneticdatastorage.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "img-fluid");
    			add_location(img, file$i, 3, 12, 1056);
    			add_location(center, file$i, 3, 4, 1048);
    			add_location(br1, file$i, 3, 87, 1131);
    			add_location(p0, file$i, 2, 0, 73);
    			add_location(em, file$i, 5, 61, 2054);
    			attr_dev(aside, "class", "marginnote");
    			add_location(aside, file$i, 5, 0, 1993);
    			add_location(p1, file$i, 6, 0, 2097);
    			add_location(p2, file$i, 8, 0, 2868);
    			add_location(blockquote, file$i, 7, 0, 2855);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, t1, anchor);
    			insert_dev(target, p0, anchor);
    			mount_component(quiz0, p0, null);
    			append_dev(p0, t2);
    			mount_component(quiz1, p0, null);
    			append_dev(p0, t3);
    			mount_component(quiz2, p0, null);
    			append_dev(p0, t4);
    			mount_component(quiz3, p0, null);
    			append_dev(p0, t5);
    			append_dev(p0, br0);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(quiz0.$$.fragment, local);
    			transition_in(quiz1.$$.fragment, local);
    			transition_in(quiz2.$$.fragment, local);
    			transition_in(quiz3.$$.fragment, local);
    			transition_in(quiz4.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(quiz0.$$.fragment, local);
    			transition_out(quiz1.$$.fragment, local);
    			transition_out(quiz2.$$.fragment, local);
    			transition_out(quiz3.$$.fragment, local);
    			transition_out(quiz4.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(h1);
    			if (detaching) detach_dev(t1);
    			if (detaching) detach_dev(p0);
    			destroy_component(quiz0);
    			destroy_component(quiz1);
    			destroy_component(quiz2);
    			destroy_component(quiz3);
    			destroy_component(quiz4);
    			if (detaching) detach_dev(t8);
    ...
    function create_fragment$n(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(quiz.$$.fragment);
    			add_location(h1, file$k, 1, 0, 51);
    			add_location(p, file$k, 2, 0, 66);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$o(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(quiz1.$$.fragment);
    			add_location(h1, file$l, 1, 0, 51);
    			add_location(p, file$l, 2, 0, 69);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, p, anchor);
    			append_dev(p, t2);
    			mount_component(quiz0, p, null);
    			append_dev(p, t3);
    			mount_component(quiz1, p, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function create_fragment$q(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$n, 1, 0, 51);
    			add_location(p1, file$n, 5, 0, 130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_sidebar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$o, 62, 24, 2975);
    			add_location(br0, file$o, 62, 85, 3036);
    			attr_dev(a1, "href", "/storage/home");
    			add_location(a1, file$o, 63, 0, 3043);
    			add_location(br1, file$o, 63, 55, 3098);
    			attr_dev(a2, "href", "/peripherals/home");
    			add_location(a2, file$o, 64, 0, 3105);
    			add_location(br2, file$o, 64, 63, 3168);
    			attr_dev(span, "slot", "sidebar");
    			add_location(span, file$o, 62, 2, 2953);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$o, 69, 8, 3278);
    			attr_dev(div1, "class", "col-md-8");
    			add_location(div1, file$o, 70, 8, 3311);
    			attr_dev(div2, "class", "col-md-3");
    			add_location(div2, file$o, 73, 8, 3387);
    			attr_dev(div3, "class", "columns");
    			add_location(div3, file$o, 68, 6, 3248);
    			attr_dev(div4, "class", "container-fluid");
    			add_location(div4, file$o, 67, 4, 3212);
    			attr_dev(span, "slot", "content");
    			add_location(span, file$o, 66, 2, 3186);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
