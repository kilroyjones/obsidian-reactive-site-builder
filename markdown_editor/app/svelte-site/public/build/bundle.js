    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong1, file$5, 2, 102, 191);
    			add_location(p0, file$5, 2, 0, 89);
    			add_location(p1, file$5, 3, 0, 230);
    			attr_dev(a1, "href", "/storage/backup");
    			add_location(a1, file$5, 4, 52, 320);
    			attr_dev(a2, "href", "/storage/direct");
    			add_location(a2, file$5, 4, 181, 449);
    			add_location(p2, file$5, 4, 0, 268);
    			add_location(em, file$5, 5, 28, 544);
    			add_location(p3, file$5, 5, 0, 516);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong0, file$7, 2, 314, 404);
    			add_location(strong1, file$7, 2, 357, 447);
    			add_location(p0, file$7, 2, 0, 90);
    			add_location(strong2, file$7, 5, 36, 702);
    			add_location(p1, file$7, 3, 0, 483);
    			add_location(strong3, file$7, 6, 18, 882);
    			attr_dev(a3, "href", "/storage/solid_state");
    			add_location(a3, file$7, 6, 47, 911);
    			add_location(p2, file$7, 6, 0, 864);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p2, file$b, 5, 0, 518);
    			add_location(p3, file$b, 7, 0, 687);
    			add_location(p4, file$b, 8, 0, 812);
    			attr_dev(a1, "href", "/storage/magnetic");
    			add_location(a1, file$b, 9, 53, 908);
    			attr_dev(a2, "href", "/storage/optical");
    			add_location(a2, file$b, 9, 104, 959);
    			attr_dev(a3, "href", "/storage/solid_state");
    			add_location(a3, file$b, 9, 156, 1011);
    			add_location(strong3, file$b, 10, 26, 1195);
    			add_location(p5, file$b, 9, 0, 855);
    			add_location(h4, file$b, 11, 0, 1297);
    			add_location(strong4, file$b, 12, 34, 1345);
    			add_location(p6, file$b, 12, 0, 1311);
    			add_location(p7, file$b, 13, 0, 1453);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr0, file$c, 2, 0, 82);
    			attr_dev(a0, "href", "/storage");
    			add_location(a0, file$c, 3, 18, 107);
    			attr_dev(a1, "href", "/storage/binary");
    			add_location(a1, file$c, 3, 67, 156);
    			add_location(p0, file$c, 3, 0, 89);
    			add_location(hr1, file$c, 4, 0, 356);
    			add_location(strong0, file$c, 5, 41, 404);
    			add_location(strong1, file$c, 5, 74, 437);
    			attr_dev(a2, "href", "/storage/magnetic");
    			add_location(a2, file$c, 5, 114, 477);
    			add_location(strong2, file$c, 5, 196, 559);
    			add_location(p1, file$c, 5, 0, 363);
    			attr_dev(a3, "href", "/storage/SSD");
    			add_location(a3, file$c, 6, 3, 599);
    			add_location(p2, file$c, 6, 0, 596);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/storage");
    			add_location(a0, file$d, 2, 21, 109);
    			add_location(strong, file$d, 2, 3, 91);
    			attr_dev(a1, "href", "/storage/data");
    			add_location(a1, file$d, 2, 103, 191);
    			attr_dev(a2, "href", "/storage/magnetic");
    			add_location(a2, file$d, 2, 160, 248);
    			attr_dev(a3, "href", "/storage/optical");
    			add_location(a3, file$d, 2, 211, 299);
    			attr_dev(a4, "href", "/storage/solid_state");
    			add_location(a4, file$d, 2, 263, 351);
    			add_location(p, file$d, 2, 0, 88);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/storage/binary");
    			add_location(a0, file$e, 2, 34, 129);
    			attr_dev(a1, "href", "/storage/hard_disks");
    			add_location(a1, file$e, 4, 47, 302);
    			attr_dev(a2, "href", "/storage/magnetic_tape");
    			add_location(a2, file$e, 4, 105, 360);
    			add_location(p, file$e, 2, 0, 95);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$h, 2, 19, 95);
    			add_location(p, file$h, 2, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$i, 1, 0, 61);
    			attr_dev(a0, "href", "/peripherals/mouse");
    			add_location(a0, file$i, 2, 11, 90);
    			attr_dev(a1, "href", "/peripherals/binary");
    			add_location(a1, file$i, 2, 59, 138);
    			add_location(p, file$i, 2, 0, 79);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_sidebar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a1, "href", "/storage");
    			add_location(a1, file$j, 55, 0, 2438);
    			add_location(br1, file$j, 55, 50, 2488);
    			attr_dev(a2, "href", "/peripherals");
    			add_location(a2, file$j, 56, 0, 2495);
    			add_location(br2, file$j, 56, 58, 2553);
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$j, 58, 2, 2571);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
