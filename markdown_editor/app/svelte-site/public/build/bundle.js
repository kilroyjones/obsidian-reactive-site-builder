...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(em, file$5, 6, 10, 535);
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p0 = element("p");
    			a0 = element("a");
    			a0.textContent = "peripherals/quizzes/question1";
    			t3 = space();
    			a1 = element("a");
    			a1.textContent = "peripherals/keyboard";
    			t5 = text(" and ");
    			a2 = element("a");
    			a2.textContent = "mouse";
    			t7 = text(" and ");
    			a3 = element("a");
    			a3.textContent = "peripherals/binary";
    			t9 = text(" vs. ");
    			a4 = element("a");
    			a4.textContent = "storage/binary";
    			t11 = text("\n![[magneticdatastorage.png]] ");
    			a5 = element("a");
    			a5.textContent = "peripherals/sub_perphs/testing";
    			...
    			attr_dev(a0, "href", "/peripherals/quizzes/question1");
    			add_location(a0, file$h, 3, 3, 85);
    			attr_dev(a1, "href", "/peripherals/keyboard");
    			add_location(a1, file$h, 4, 0, 169);
    			attr_dev(a2, "href", "/peripherals/mouse");
    			add_location(a2, file$h, 4, 70, 239);
    			attr_dev(a3, "href", "/peripherals/binary");
    			add_location(a3, file$h, 4, 122, 291);
    			attr_dev(a4, "href", "/storage/binary");
    			add_location(a4, file$h, 4, 188, 357);
    			attr_dev(a5, "href", "/peripherals/sub_perphs/testing");
    			add_location(a5, file$h, 5, 29, 440);
    			add_location(em, file$h, 8, 66, 1215);
    			add_location(p0, file$h, 3, 0, 82);
    			add_location(p1, file$h, 9, 0, 1256);
    			add_location(p2, file$h, 11, 0, 2027);
    			add_location(blockquote, file$h, 10, 0, 2014);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$n(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$k, 3, 11, 89);
    			attr_dev(a1, "href", "/peripherals/binary");
    			add_location(a1, file$k, 3, 59, 137);
    			add_location(p, file$k, 3, 0, 78);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$l = "src/content/peripherals/sub_perphs/testing.svelte";
    ...
    function create_fragment$p(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text("this is testing\n");
    			a = element("a");
    			a.textContent = "peripherals/quizzes/question1";
    			attr_dev(a, "href", "/peripherals/quizzes/question1");
    			add_location(a, file$l, 3, 0, 79);
    			add_location(p, file$l, 2, 0, 60);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$m = "src/content/peripherals/quizzes/question1.svelte";
    ...
    function create_sidebar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$n, 64, 24, 3144);
    			add_location(br0, file$n, 64, 85, 3205);
    			attr_dev(a1, "href", "/storage/home");
    			add_location(a1, file$n, 65, 0, 3212);
    			add_location(br1, file$n, 65, 55, 3267);
    			attr_dev(a2, "href", "/peripherals/home");
    			add_location(a2, file$n, 66, 0, 3274);
    			add_location(br2, file$n, 66, 63, 3337);
    			attr_dev(span, "slot", "sidebar");
    			add_location(span, file$n, 64, 2, 3122);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$n, 71, 8, 3447);
    			attr_dev(div1, "class", "col-md-8");
    			add_location(div1, file$n, 72, 8, 3480);
    			attr_dev(div2, "class", "col-md-3");
    			add_location(div2, file$n, 75, 8, 3556);
    			attr_dev(div3, "class", "columns");
    			add_location(div3, file$n, 70, 6, 3417);
    			attr_dev(div4, "class", "container-fluid");
    			add_location(div4, file$n, 69, 4, 3381);
    			attr_dev(span, "slot", "content");
    			add_location(span, file$n, 68, 2, 3355);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
