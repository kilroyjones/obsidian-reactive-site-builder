...
var app = (function () {
    ...
    /* src/content/with_space.svelte generated by Svelte v3.31.0 */
    ...
    function instance$2($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("With_space", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<With_space> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class With_space extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$1 = "src/content/with_space/testing.svelte";
    ...
    const file$2 = "src/content/storage.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "Storage devices in computer systems are the components that [[storage/binary]] data is stored on and retrieved from. Temporary memory including RAM is [[primary]] storage, while permanent memory where files are saved for long-term use is [[secondary]] storage.";
    			t3 = space();
    			p1 = element("p");
    			t4 = text("There are ");
    			strong = element("strong");
    			strong.textContent = "three";
    			t6 = text(" main categories of storage devices in a computer: [[magnetic]], [[optical]] and [[solid state storage]].");
    			add_location(h1, file$2, 0, 0, 0);
    			add_location(p0, file$2, 1, 0, 17);
    			add_location(strong, file$2, 2, 13, 298);
    			add_location(p1, file$2, 2, 0, 285);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			t2 = text("Magnetic tape is a [[serial]] storage device that stores data ");
    			strong0 = element("strong");
    			strong0.textContent = "sequentially";
    			t4 = text(" on the magnetically-coated surface of a plastic tape.\n![[sequentialdatastorage.png]]\nData stored in this way makes accessing a specific file a very slow process, but it is useful as a [[backup]] storage medium due to its ");
    			...
    			add_location(strong0, file$3, 1, 65, 88);
    			add_location(strong1, file$3, 3, 136, 339);
    			add_location(strong2, file$3, 3, 179, 382);
    			add_location(p, file$3, 1, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(" data [[storage]] devices, data is stored in ");
    			strong1 = element("strong");
    			...
    			t9 = space();
    			p2 = element("p");
    			p2.textContent = "This approach can be highly effective for use in [[backup]] strategies, but is less useful when files need to be accessed randomly as it is in [[direct]] storage devices.";
    			t11 = space();
    			p3 = element("p");
    			t12 = text("[[Magnetic tape]] is the ");
    			em = element("em");
    			em.textContent = "only";
    			t14 = text(" example of a serial data storage device in the syllabus.");
    			add_location(h1, file$5, 0, 0, 0);
    			add_location(strong0, file$5, 1, 6, 34);
    			add_location(strong1, file$5, 1, 74, 102);
    			add_location(p0, file$5, 1, 0, 28);
    			add_location(p1, file$5, 2, 0, 141);
    			add_location(p2, file$5, 3, 0, 179);
    			add_location(em, file$5, 4, 28, 385);
    			add_location(p3, file$5, 4, 0, 357);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p0 = element("p");
    			t2 = text("Hard disks magnetically charge sectors of rotating platters to store [[storage/binary]] data. They are [[secondary]] [[storage]] devices that are commonly found in desktop and laptop computers because of their ");
    			strong0 = element("strong");
    			...
    			t7 = space();
    			p1 = element("p");
    			t8 = text("Hard drive capacities have expanded in recent years due tosectors on drives being made smaller, and by more platters being included inside the drive itself.\n![[readwritehead.png]]\nData is read from the platters by a ");
    			strong2 = element("strong");
    			strong2.textContent = "read/write head";
    			t10 = text(" that is so close to the platter that a single piece of dust could damage it, so the enclosures are sealed to prevent damage.");
    			t11 = space();
    			p2 = element("p");
    			t12 = text("Hard disks are ");
    			strong3 = element("strong");
    			strong3.textContent = "slower";
    			t14 = text(" than [[solid state]] forms of storage because of the moving parts inside the enclosure.");
    			add_location(h1, file$7, 0, 0, 0);
    			add_location(strong0, file$7, 1, 213, 242);
    			add_location(strong1, file$7, 1, 256, 285);
    			add_location(p0, file$7, 1, 0, 29);
    			add_location(strong2, file$7, 4, 36, 540);
    			add_location(p1, file$7, 2, 0, 321);
    			add_location(strong3, file$7, 5, 18, 720);
    			add_location(p2, file$7, 5, 0, 702);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$9, 1, 3, 19);
    			add_location(p, file$9, 1, 0, 16);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Data in computer systems is stored using [[storage/binary]] code on a variety of [[storage]] devices.";
    			add_location(h1, file$a, 0, 0, 0);
    			add_location(p, file$a, 1, 0, 14);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = text(" (binary digit), which is held in [[storage]] using some form of on/off switch. You can use a form of binary counting to count to 31 on the fingers of one hand.");
    			t13 = space();
    			p2 = element("p");
    			...
    			t19 = space();
    			p5 = element("p");
    			t20 = text("The way that bits are represented is different in [[magnetic]], [[optical]] and [[solid state]] storage devices, but the principle remains the same: combinations of 0s and 1s just like the fingers \nBits can be combined into ");
    			strong3 = element("strong");
    			strong3.textContent = "strings";
    			t22 = text(" that can represent a wide variety of different kinds of data, including:");
    			t23 = space();
    			h4 = element("h4");
    			h4.textContent = "Text";
    			t25 = space();
    			p6 = element("p");
    			t26 = text("Each letter of the alphabet is ");
    			strong4 = element("strong");
    			strong4.textContent = "one byte long";
    			t28 = text(", with each letter being represented in binary by eight bits, as follows:");
    			t29 = space();
    			p7 = element("p");
    			p7.textContent = "| Letter | Binary   |\n|--------|----------|\n| A      | 01000001 |\n| B      | 01000010 |\n| C      | 01000011 |\n| D      | 01000100 |";
    			add_location(h1, file$b, 0, 0, 0);
    			add_location(strong0, file$b, 1, 83, 99);
    			add_location(strong1, file$b, 1, 107, 123);
    			add_location(p0, file$b, 1, 0, 16);
    			add_location(h2, file$b, 2, 0, 188);
    			add_location(strong2, file$b, 3, 32, 244);
    			add_location(p1, file$b, 3, 0, 212);
    			add_location(p2, file$b, 4, 0, 429);
    			add_location(p3, file$b, 6, 0, 598);
    			add_location(p4, file$b, 7, 0, 723);
    			add_location(strong3, file$b, 9, 26, 993);
    			add_location(p5, file$b, 8, 0, 766);
    			add_location(h4, file$b, 10, 0, 1095);
    			add_location(strong4, file$b, 11, 34, 1143);
    			add_location(p6, file$b, 11, 0, 1109);
    			add_location(p7, file$b, 12, 0, 1251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$c = "src/content/storage/solid_state.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p0 = element("p");
    			p0.textContent = "In solid state [[storage]] devices, [[storage/binary]] data is stored with the presence or absence of an electrical charge, meaning there are no moving parts as there are in other storage devices.";
    			t4 = space();
    			hr1 = element("hr");
    			t5 = space();
    			p1 = element("p");
    			t6 = text("As a result, solid state devices are  ");
    			strong0 = element("strong");
    			strong0.textContent = "much faster";
    			t8 = text(" and ");
    			strong1 = element("strong");
    			strong1.textContent = "more robust";
    			t10 = text(" than their [[magnetic]] counterparts, and are generally ");
    			strong2 = element("strong");
    			...
    			add_location(hr0, file$c, 1, 0, 21);
    			add_location(p0, file$c, 2, 0, 28);
    			add_location(hr1, file$c, 3, 0, 232);
    			add_location(strong0, file$c, 4, 41, 280);
    			add_location(strong1, file$c, 4, 74, 313);
    			add_location(strong2, file$c, 4, 159, 398);
    			add_location(p1, file$c, 4, 0, 239);
    			add_location(p2, file$c, 5, 0, 435);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src/content/storage/secondary.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			strong = element("strong");
    			strong.textContent = "Secondary [[storage]]";
    			t3 = text(" refers to any permanent store of [[data]]. This includes [[magnetic]], [[optical]] and [[solid state]] storage.");
    			add_location(h1, file$d, 0, 0, 0);
    			add_location(strong, file$d, 1, 3, 30);
    			add_location(p, file$d, 1, 0, 27);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src/content/storage/magnetic.svelte";
    ...
    const file$f = "src/content/peripherals.svelte";
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "[[keyboard]] and [[mouse]] and [[peripherals/binary]] vs. [[storage/binary]]";
    			add_location(h1, file$f, 0, 0, 0);
    			add_location(p, file$f, 1, 0, 22);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$h = "src/content/peripherals/mouse.svelte";
    ...
    const file$i = "src/content/peripherals/keyboard.svelte";
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "link to [[mouse]] [[peripherals/binary]]";
    			add_location(h1, file$i, 0, 0, 0);
    			add_location(p, file$i, 1, 0, 18);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_sidebar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br2 = element("br");
    			t5 = text("\"");
    			attr_dev(a0, "href", "/with_space");
    			add_location(a0, file$j, 54, 24, 2375);
    			add_location(br0, file$j, 54, 80, 2431);
    			attr_dev(a1, "href", "/storage");
    			add_location(a1, file$j, 55, 0, 2439);
    			add_location(br1, file$j, 55, 50, 2489);
    			attr_dev(a2, "href", "/peripherals");
    			add_location(a2, file$j, 56, 0, 2497);
    			add_location(br2, file$j, 56, 58, 2555);
    			attr_dev(span, "slot", "sidebar");
    			add_location(span, file$j, 54, 2, 2353);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_content_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$j, 58, 2, 2574);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
