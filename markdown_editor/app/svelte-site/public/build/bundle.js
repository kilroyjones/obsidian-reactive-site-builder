...
var app = (function () {
    ...
    // (84:6) {#each question['answers'] as answer, answer_index}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button = element("button");
    			t = text(t_value);
    			attr_dev(button, "class", button_class_value = "btn " + /*active*/ ctx[1][/*question_index*/ ctx[9]][/*answer_index*/ ctx[12]] + " svelte-cxioc8");
    			add_location(button, file$m, 85, 10, 1688);
    			add_location(div, file$m, 84, 8, 1672);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*active*/ 2 && button_class_value !== (button_class_value = "btn " + /*active*/ ctx[1][/*question_index*/ ctx[9]][/*answer_index*/ ctx[12]] + " svelte-cxioc8")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:6) {#each question['answers'] as answer, answer_index}",
    		ctx
    	});
    ...
    // (81:2) {#each questions as question, question_index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "question svelte-cxioc8");
    			add_location(div, file$m, 81, 4, 1554);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(81:2) {#each questions as question, question_index}",
    		ctx
    	});
    ...
    function create_fragment$p(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "data-column correct svelte-cxioc8");
    			add_location(div0, file$m, 97, 8, 2016);
    			attr_dev(div1, "class", "col-sm-4");
    			add_location(div1, file$m, 96, 6, 1985);
    			attr_dev(div2, "class", "data-column incorrect svelte-cxioc8");
    			add_location(div2, file$m, 100, 8, 2116);
    			attr_dev(div3, "class", "col-sm-4 ");
    			add_location(div3, file$m, 99, 6, 2084);
    			attr_dev(div4, "class", "data-column score svelte-cxioc8");
    			add_location(div4, file$m, 103, 8, 2219);
    			attr_dev(div5, "class", "col-sm-4");
    			add_location(div5, file$m, 102, 6, 2188);
    			attr_dev(div6, "class", "row data-row svelte-cxioc8");
    			add_location(div6, file$m, 95, 4, 1952);
    			attr_dev(div7, "class", "question svelte-cxioc8");
    			add_location(div7, file$m, 94, 2, 1925);
    			attr_dev(div8, "class", "container");
    			add_location(div8, file$m, 79, 0, 1478);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Quiz extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$p, create_fragment$p, safe_not_equal, { questions: 0 });
    ...
    function create_fragment$q(ctx) {
    	...
    	quiz = new Quiz({
    			props: {
    				questions: [
    					{
    						question: "Which is a duck?",
    						answers: ["Mallard", "Buffalo"],
    						correct: [1, 0]
    					},
    					{
    						question: "Which is a mammal?",
    						answers: ["Mallard", "Buffalo", "Egret"],
    						correct: [0, 1, 0]
    					},
    					{
    						question: "Which is a person?",
    						answers: ["Mallard", "Harriet", "Beatrice", "Buffalo"],
    						correct: [0, 1, 1, 0]
    					}
    				]
    			},
