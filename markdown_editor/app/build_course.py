...
class BuildCourse:
    ...
    def load(self):
        ...
        for item in files:
            ...
            if os.path.isdir(file_path) and str(item + ".md") in files:
                ...
                self.all_page_paths += [item + '/' + page[:-3].replace(' ', '_') for page in os.listdir(os.path.join(self.source_path, item))]
    ...
    def parse_page_links(self, section, page_content):
        ...
        for match in matches: 
            ...
            if link in self.all_page_paths:
                page_content = page_content.replace(md, '<a href=\"/' + link + '\" use:link>' + title + '</a>')
        return page_content 
    ...
    def create_routes(self):
        ...
        for section in self.sections:
            ...
            sidebar += '<a href=\"/' + section + '\" ' + 'use:link use:active>' + section_capped + '</a><br>' + '\n'
